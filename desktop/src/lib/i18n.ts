...
export const TRANSLATIONS = {
  en: {
    ...
    exportDialog: {
      title: "Export",
      desc: "Export this day's log.",
      copyMarkdown: "Copy as Markdown",
      copyCSV: "Copy as CSV",
      exportPDF: "Print day as PDF",
      exportWeekPDF: "Print week as PDF",
      forNotes: "for notes",
      forSpreadsheets: "for spreadsheets",
      forPrint: "opens print dialog",
      copied: "Copied",
      emptyNote: "Nothing's logged for this day yet.",
      comingSoon: "coming soon",
    },
    welcome: {
      title: "Welcome to Prowtein",
      sub: "What should we call you?",
      label: "Your name",
      placeholder: "e.g. Alex",
      skip: "Skip",
      cta: "Continue",
      statsTitle: "Your body stats",
      statsSub: "We'll calculate your initial goals. You can always change them in Settings.",
      calculateBtn: "Start",
      skipStats: "Skip for now",
    ...
    bodyStats: {
      ...
      maintain: "Maintain",
      gain: "Build muscle",
      recalculate: "Recalculate goals",
      calculated: "Goals auto-set from your stats",
    },
  },
  ...
  de: {
    ...
    exportDialog: {
      title: "Export",
      desc: "Protokoll dieses Tages exportieren.",
      copyMarkdown: "Als Markdown kopieren",
      copyCSV: "Als CSV kopieren",
      exportPDF: "Tag als PDF drucken",
      exportWeekPDF: "Woche als PDF drucken",
      forNotes: "für Notizen",
      forSpreadsheets: "für Tabellen",
      forPrint: "öffnet Druckdialog",
      copied: "Kopiert",
      emptyNote: "Für diesen Tag ist noch nichts eingetragen.",
      comingSoon: "demnächst",
    },
    welcome: {
      title: "Willkommen bei Prowtein",
      sub: "Wie sollen wir dich nennen?",
      label: "Dein Name",
      placeholder: "z.B. Alex",
      skip: "Überspringen",
      cta: "Weiter",
      statsTitle: "Deine Körperdaten",
      statsSub: "Wir berechnen deine Startziele. Du kannst alles in den Einstellungen ändern.",
      calculateBtn: "Starten",
      skipStats: "Jetzt überspringen",
      suggestedGoals: "Vorgeschlagene Ziele",
    },
    bodyStats: {
      weight: "Gewicht",
      height: "Größe",
      ...
      maintain: "Halten",
      gain: "Aufbauen",
      recalculate: "Ziele neu berechnen",
      calculated: "Ziele anhand deiner Daten berechnet",
    },
  },
  ...
  tr: {
    ...
    settings: {
      ...
      language: "Dil",
      name: "Adın",
      namePlaceholder: "örn. Alex",
    },
    exportDialog: {
      title: "Dışa aktar",
      desc: "Bu günün kaydını dışa aktar.",
      copyMarkdown: "Markdown olarak kopyala",
      copyCSV: "CSV olarak kopyala",
      exportPDF: "Günü PDF olarak yazdır",
      exportWeekPDF: "Haftayı PDF olarak yazdır",
      forNotes: "notlar için",
      forSpreadsheets: "tablolar için",
      forPrint: "yazdırma iletişim kutusunu açar",
      copied: "Kopyalandı",
      emptyNote: "Bu gün için henüz bir şey kaydedilmedi.",
      comingSoon: "yakında",
    },
    welcome: {
      title: "Prowtein'e hoş geldin",
      sub: "Sana nasıl hitap edelim?",
      label: "Adın",
      placeholder: "örn. Alex",
      skip: "Geç",
      cta: "Devam et",
      statsTitle: "Vücut bilgilerin",
      statsSub: "İlk hedeflerini hesaplayacağız. Ayarlardan istediğin zaman değiştirebilirsin.",
      calculateBtn: "Başla",
      skipStats: "Şimdilik geç",
      suggestedGoals: "Önerilen hedefler",
    },
    bodyStats: {
      weight: "Kilo",
      height: "Boy",
      ...
      gain: "Kas kazan",
      recalculate: "Hedefleri yeniden hesapla",
      calculated: "Hedefler vücut bilgilerine göre hesaplandı",
    },
  },
} as const;
